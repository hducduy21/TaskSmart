package com.tasksmart.notification.configs;
...
public class SecurityConfig {
    ...
    private static final String[] PERMIT_ALL_ENDPOINTS = {"/api/verify/**", "/api/internal/verify/**", "/actuator/**", "/actuator/prometheus"};
